...
const ticketTexto = "La impresora Zebra de recepción no imprime etiquetas desde hoy.";
// ====== AGENTE ======
const response = await client.responses.create({
    ...
    input: [
        {
            role: "system",
            content: "Eres un agente TI. TODO incidente reportado por usuario debe generar un ticket usando obligatoriamente la herramienta crearTicket."
        },
        {
            role: "user",
            content: ticketTexto
...
//# sourceMappingURL=01-agent-tool.mjs.map